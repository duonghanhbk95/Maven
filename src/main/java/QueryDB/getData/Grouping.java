...
public class Grouping {
    public List getVector(List goal, List task, List quality, List resource) {
        ...
        if(goal.size()== 0 ) emp.add(""); 
        else 
        	if (goal.size() ==1) emp.add(goal.get(0));
	        else {
        ...
        if(task.size()== 0 ) emp.add(""); 
        else 
        	if (task.size() ==1) emp.add(task.get(0));
        	else {
        ...
        if(quality.size()== 0 ) emp.add(""); 
        else 
        	if (quality.size() ==1) emp.add(quality.get(0));
        	else {
        ...
        if(resource.size()== 0 ) emp.add(""); 
        else 
        	if (resource.size() ==1) emp.add(resource.get(0));
        	else {
